...
const patches = [
  ...
  {
    name: "registration communication journeys",
    sql: `
      ALTER TYPE "CommunicationStatus" ADD VALUE IF NOT EXISTS 'SKIPPED' BEFORE 'SENDING';

      ALTER TABLE "CohortCommunication" ADD COLUMN IF NOT EXISTS "registrationId" TEXT;
      ALTER TABLE "CohortCommunication" ADD COLUMN IF NOT EXISTS "participantId" TEXT;
      ALTER TABLE "CohortCommunication" ADD COLUMN IF NOT EXISTS "journeyKey" TEXT;
  ...
  {
    name: "backfill cohort schedule dates",
    sql: `
    ...
    sql: `
      ...
      BEGIN
        ...
        IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'CohortCommunication_registrationId_fkey') THEN
          ALTER TABLE "CohortCommunication" ADD CONSTRAINT "CohortCommunication_registrationId_fkey" FOREIGN KEY ("registrationId") REFERENCES "Registration"("id") ON DELETE SET NULL ON UPDATE CASCADE;
        END IF;

        IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'CohortCommunication_participantId_fkey') THEN
          ALTER TABLE "CohortCommunication" ADD CONSTRAINT "CohortCommunication_participantId_fkey" FOREIGN KEY ("participantId") REFERENCES "Participant"("id") ON DELETE SET NULL ON UPDATE CASCADE;
        END IF;
      END $$;
    `
  }
