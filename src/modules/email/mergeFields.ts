...
const allowedFields = new Set([
  ...
  "organization.zip",
  "organization.phone",
  "registration.primaryContactFirstName",
...
export const sampleMergeContext: MergeFieldContext = {
  cohort: {
    ...
    guideTopic: "instructional leadership routines",
    guideUrl: "https://rocketpd.com/guides/instructional-leadership",
    podcastUrl: "https://www.youtube.com/@rocketpd",
  ...
  registration: {
    ...
    invoiceSentDate: "May 1, 2026",
    purchaseOrderNumber: "PO-2026-1001",
    purchaseOrderLine: "Purchase order: PO-2026-1001",
    purchaseOrderBullet: "- Purchase order: PO-2026-1001",
    paymentMethod: "Purchase Order",
    paymentStatus: "INVOICED",
    participantCount: "4",
    participantRosterNextStep: "We received the participant information you shared, so there is nothing else you need to do right now.",
    totalAmount: "$3,180",
